define({ "api": [
  ...
  },
  {
    ...
    "title": "Export",
    "name": "export_(need_a_\"files\"_directory_in_project_root)",
    "group": "User",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Message New report has been created, our team will examinate it as soon as possible !</p>"
          }
        ]
      },
      "examples": [
    ...
    "error": {
      ...
      "examples": [
        {
          "title": "Error Response if itemId has alrealdy been reported",
